...
//   useEffect(() => {
//     if (!idUser || !end_time|| !payment_ref||!start_time||!numTable) {
...
//         const response = await fetch(`http://localhost:8000/ELACO/booking/verify/${payment_ref}`, {
//           method: "GET",
//           credentials: "include",
//         });
...
//     getStatus();
//   }, [idUser,end_time,end_time,start_time, numTable,payment_ref]);
